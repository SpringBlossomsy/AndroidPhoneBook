...
public class ReFlashListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initHeadView() {
        mHeadView = View.inflate(getContext(), R.layout.header_layout, null);
    ...
    private void initFoodView() {
        mFooterView = View.inflate(getContext(), R.layout.footer_layout, null);
     ...
     */
    public void setOnRefreshListener(ReFlashListView.onRefreshListener onRefreshListener) {
